          ...
          <div className="max-w-7xl mx-auto space-y-8 pb-12">
            ...
            <section className="flex flex-col md:flex-row md:items-end justify-between gap-4">
              ...
              <div className="flex gap-3">
                <button
                  type="button"
                  className="px-4 py-2 rounded-lg bg-surface-container border border-outline-variant/30 text-sm text-on-surface hover:bg-surface-container-high transition-colors"
                >
                  Today
                </button>
              </div>
